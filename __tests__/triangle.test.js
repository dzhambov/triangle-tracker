...
describe('Triangle', () => {
  ...
  test('should correctly determine whether three lengths make an eqilateral triangle', () => {
    var equilTriangle = new Triangle(5,5,5)
    expect(equilTriangle.checkType()).toEqual("equilateral triangle");
  });
  test('should correctlt determine whether the input value is greater than 0', () => {
    var negNumber = new Triangle(-1,-1,-1)
    expect(negNumber.checkType()).toEqual("Please enter a value greater than 0.");
  });
});
